...
par(mfrow = c(2,3))  
plot(log(bhazs[chaz1>0 & chemo==1][["time"]]),log(bhazs[chaz1>0 & chemo==1][["chaz1"]]))
plot(log(bhazs[chaz0>0 & chemo==1][["time"]]),log(bhazs[chaz0>0 & chemo==1][["chaz0"]])) 
plot(log(bhazs[chaz2>0 & chemo==1][["time"]]),log(bhazs[chaz2>0 & chemo==1][["chaz2"]])) 
plot(log(bhazs[chaz1>0 & chemo==0][["time"]]),log(bhazs[chaz1>0 & chemo==0][["chaz1"]]))
plot(log(bhazs[chaz0>0 & chemo==0][["time"]]),log(bhazs[chaz0>0 & chemo==0][["chaz0"]])) 
plot(log(bhazs[chaz2>0 & chemo==0][["time"]]),log(bhazs[chaz2>0 & chemo==0][["chaz2"]]))
#+END_SRC

#+RESULTS[(2022-07-13 14:52:35) 876b324427583dd1cce52756fc5e0e712fb0f8c0]:
