...
#+ATTR_LATEX: :options otherkeywords={}, deletekeywords={}
#+BEGIN_SRC R  :results none :exports none  :session *R* :cache yes
contmle.results <- do.call("rbind", lapply(list("Rand. tr. + ind. cens.", "Inf cens."), function(outer.which) {
    out.inner <- data.table(do.call("rbind", lapply(list("hal", "cox", "rf"), function(inner.initial) {
        try(unlist(follic.output.fun(M = 500,
                                     randomized.treatment = outer.which == "Rand. tr. + ind. cens.",
                                     observed.treatment = outer.which != "Rand. tr. + ind. cens.",
                                     informative.censoring = outer.which != "Rand. tr. + ind. cens.",
...
survtmle.results <- do.call("rbind", lapply(list("Rand. tr. + ind. cens.", "Inf cens."), function(outer.which) {
...
#+BEGIN_SRC R :results file graphics :file ./simulation/output/simultation-results.png :exports none :session *R* :cache yes :height 500 :width 500
...
#+RESULTS[(2022-07-21 09:53:28) 6f872f353c990ccebad001a0c6a17d79dee7389c]:
...
#+RESULTS[(2022-07-21 09:53:31) b0f40ab943334f17c611182fc47a8625d240f14b]:
